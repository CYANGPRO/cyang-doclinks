...
const permissionLabels: Record<Permission, string> = {
  ...
  viewCampaigns: "View campaigns and search campaign members",
  assignCampaignMembers: "Claim or update authorized campaign assignments",
  assignCampaignMembersOrganizationWide: "Assign campaign members across organizer roles",
