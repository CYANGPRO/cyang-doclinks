...
export default async function ContactCorrectionsPage() {
  ...
  return <ProtectedPage permission="manageImports"><div className="content contact-corrections-page">
    ...
    />
    {unavailable ? <UnavailableState title="Contact updates are unavailable" description="We couldn’t load the protected review queue, so no proposed contact details are shown. Reference: CONTACT_UPDATES_UNAVAILABLE." action={<Link className="button secondary" href="/membership/contact-corrections">Try again</Link>} /> :
