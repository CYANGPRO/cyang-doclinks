...
export default async function ImportsPage() {
  ...
  return <ProtectedPage permission="manageImports"><div className="content">
    ...
    <ImportPreviewForm durablePreviewAvailable={process.env.VERCEL_ENV !== "production" && process.env.LOCAL801_PREVIEW_AUTH_ENABLED === "1" && process.env.LOCAL801_DURABLE_IMPORTS_ENABLED === "1"} />
  </div></ProtectedPage>;
}
