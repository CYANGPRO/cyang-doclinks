...
| R2 application objects | Manual bounded inventory/dry-run/ciphertext-copy workflow using separate source-read and destination-write credentials; destination size/checksum/metadata verification; do not assume ordinary object metadata equals recoverable version history | CAT + Cloudflare | Runs 32597932286, 32598018680, and 32598092186 inventoried, dry-ran, copied, and verified all 28 ciphertext objects; synthetic key-read/cleanup is still pending |
